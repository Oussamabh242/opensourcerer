...
Tokens generated are related to the programming language philosophy and design.
...
the words generated by The `Tokenizer` are iterated through to make tokens or lets say IDs for example an `Else` Lex or `StringLiteral("jpl")`.
    this is a code snippet about the kinds of tokens jpl has [JPL/src/lexer/types.rs](https://github.com/Oussamabh242/jpl/blob/main/src/lexer/types.rs)
    ```Rust
